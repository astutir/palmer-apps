...
<div style="text-align: center;">
    ...
    display:inline-flex;border-style:groove;border-top: 15cap;padding: 2%;margin: 5% 0;border-width: 25px;">The Paramater Imputation Window</h2>
</div>
""",
...
# Encode fitur ordinal (island & gender)
encode = ["sex", "island"]
if upload_file is not None:
    ...
    # Concat inputan & dataset (horizontal, axis=0)
...
st.markdown(
        ...
        <div style="">
            ...
            border-style:double;border-top: 15px;padding: 2%;margin: 10% 0;border-width: 5px;text-decoration: wavy; box-shadow: 0px 0px 10px 2px rgba(0,0,0,0.5);display:inline-block;">The Result of Species Prediction</h3>
        </div>
        """,
        unsafe_allow_html=True
    )
...
st.markdown(
        ...
        <div style="">
            <h3 style="color: #11009E;
            background-color:#FFF78A;border-radius: 25%;text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5);
            border-style:double;border-top: 15px;padding: 1%;margin: 5% 0;border-width: 5px; box-shadow: 0px 0px 10px 2px rgba(0,0,0,0.5);display:inline-block;">Probality Prediction</h3>
        </div>
        """,
        unsafe_allow_html=True
    )
...
#     <h7 style="color: #6DB9EF;
#     ">Keterangan Label Kelas</h7>
# </div>
# """,
#     unsafe_allow_html=True
# )
# # Display labels with indices
# for index, label in enumerate(jenis_penguin, start=0):
